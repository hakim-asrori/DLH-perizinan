...
<html lang="en">
  <head>
    ...
    <title>Perizinan Teknis Kota Cirebon</title>
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="proses_login.php" id="login" name="login" method="post">
              ...
              <div class="separator">
                <div>
                  <h2><i class="fa fa-institution"></i> DINAS LINGKUNGAN HIDUP KOTA CIREBON</h2>
                  <p>2022 Muhammad novan wahyudi</p>
                </div>
              </div>
            </form>
          </section>
